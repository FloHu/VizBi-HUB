...
This data file is published by the Movebank Data Repository (www.datarepository.movebank.org). As of the time of publication, a version of the published animal tracking data set can be viewed on Movebank (www.movebank.org) in the study "Lesser Kestrels EBD". Individual attributes in the data files are defined below and in the Movebank Attribute Dictionary, available at www.movebank.org/node/2381.

These published data exclude ~20,000 records, representing failed fixes and outliers, that were also not used in the analysis described in the paper. A related dataset, containing flight parameters obtained from the movement data published here, is available at http://hdl.handle.net/10261/123225.

This data package includes the following data files:
Lesser Kestrels EBD.csv
Lesser Kestrels EBD-reference-data.csv

These data are described in the following written publication:
Hernández-Pliego J, Rodríguez C, Bustamante J (2015) Why do kestrels soar? PLOS ONE. 10(12): e0145402. doi:10.1371/journal.pone.0145402

Data package citation:
Hernández-Pliego J, Rodríguez C, Bustamante J (2015) Data from: Why do kestrels soar? Movebank Data Repository. doi:10.5441/001/1.sj8t3r11
